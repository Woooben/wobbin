...
(function bootWobbinLayout(){
  ...
  function ensureStyles(){
    ...
    const style=document.createElement('style');style.id='wobbin-layout-style';style.textContent=`
      .topbar{width:100%!important;max-width:none!important;height:auto!important;min-height:76px;margin:0!important;padding:14px max(24px,calc((100vw - 1480px)/2)) 10px!important;grid-template-columns:minmax(300px,1fr) minmax(420px,620px) minmax(250px,1fr)!important;gap:28px!important;background:color-mix(in srgb,var(--bg) 98%,transparent)!important;backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px)}
      .topbar .brand{justify-self:start;gap:16px!important;min-width:0}.topbar .searchbar{width:100%;max-width:620px;justify-self:center;cursor:text}.topbar .actions{justify-self:end}
      ...
      .main{width:min(calc(100% - 48px),1480px)!important;max-width:1480px!important;margin:0 auto!important;padding-left:0!important;padding-right:0!important}.main>.quick-elements,.wobbin-quick-elements{display:none!important}.subnav{justify-content:flex-start!important}.subnav-left{gap:14px!important}
      ...
      @media(max-width:1100px){.topbar{width:100%!important;padding-inline:18px!important;grid-template-columns:1fr minmax(320px,520px) auto!important;gap:18px!important}.main{width:min(calc(100% - 36px),1480px)!important}.wobbin-shortcut-nav{gap:40px}.wobbin-shortcut-links{gap:8px 22px}}
      @media(max-width:760px){.topbar{width:100%!important;grid-template-columns:1fr auto!important;gap:12px!important;padding:12px 14px 10px!important}.topbar .searchbar{grid-column:1/-1;grid-row:2;max-width:none}.topbar .actions{grid-column:2;grid-row:1}.topbar .brand{grid-column:1;grid-row:1}.main{width:min(calc(100% - 28px),1480px)!important}.wobbin-shortcut-nav{grid-template-columns:1fr;gap:26px;margin-top:4px}.wobbin-shortcut-links{grid-template-columns:repeat(2,minmax(0,1fr))}.wobbin-shortcut-link{font-size:15px}}
