...
(function loadWobbinWebPackages(){if(document.querySelector('script[data-wobbin-web-packages]'))return;const script=document.createElement('script');script.src='./wobbin-web-packages.js';script.dataset.wobbinWebPackages='1';document.body.append(script)})();
(function loadWobbinWebProductScope(){if(document.querySelector('script[data-wobbin-web-product-scope]'))return;const script=document.createElement('script');script.src='./wobbin-web-product-scope.js';script.dataset.wobbinWebProductScope='1';document.body.append(script)})();
(function loadWobbinWebAvatar(){if(document.querySelector('script[data-wobbin-web-avatar]'))return;const script=document.createElement('script');script.src='./wobbin-web-avatar.js';script.dataset.wobbinWebAvatar='1';document.body.append(script)})();
(function loadWobbinUploadProductMeta(){if(document.querySelector('script[data-wobbin-upload-product-meta]'))return;const script=document.createElement('script');script.src='./wobbin-upload-product-meta.js';script.dataset.wobbinUploadProductMeta='1';document.body.append(script)})();
(function loadWobbinLogoPriority(){if(document.querySelector('script[data-wobbin-logo-priority]'))return;const script=document.createElement('script');script.src='./wobbin-logo-priority.js';script.dataset.wobbinLogoPriority='1';document.body.append(script)})();
(function loadWobbinCustomProductTypes(){if(document.querySelector('script[data-wobbin-custom-product-types]'))return;const script=document.createElement('script');script.src='./wobbin-custom-product-types.js';script.dataset.wobbinCustomProductTypes='1';document.body.append(script)})();
